...
if [[ ! $(zsh --version 2>/dev/null) ]]; then
	...
	for package in fd-find ripgrep guake git vim-gnome bat tmux curl zsh powerline fonts-powerline python3-venv python3-pip python-pip jq csvtool xclip gnome-tweaks chrome-gnome-shell htop p7zip-full rename unzip wipe; do
