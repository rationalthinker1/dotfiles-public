# Generated by Powerlevel10k configuration wizard on 2025-12-08 at 04:55 EST.
...
# vertical separators, flat heads, flat tails, 2 lines, disconnected, left frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # asdf                  # asdf version manager (disabled - using apt packages instead)
    ...
    screen                  # gnu screen session indicator
  ...
  function prompt_screen() {
    [[ -n "${STY}" ]] || return
    p10k segment -f 213 -t "screen:${STY#*.}"
  }
