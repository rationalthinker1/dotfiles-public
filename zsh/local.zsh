...
alias portal='cd /opt/lampp/htdocs/geeg'
alias eco='sshrc -p 222 raza@138.197.166.221'
alias ohs='sshrc -p 222 raza@138.197.162.117'
alias ews='sshrc -p 222 raza@159.203.8.43'
